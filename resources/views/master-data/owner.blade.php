...
@endsection
@section('content')
{{Html::bsHomeOpenMenu('Master Data Owner / Penjual','tambah-data','Tambah Data')}}
...
{{Html::bsModalOpenLg('master-data-owner/add', 'tambah-data', 'Tambah Data')}}
...
@if(ucu())
{{Html::bsModalOpenLg('master-data-owner/update', 'update-data', 'Ubah Data')}}
    {{form::bsHidden('uuidU')}}
...
@if(ucd())
{{Html::bsModalOpen('master-data-owner/delete', 'delete-data', 'Hapus Data')}}
    {{form::bsHidden('uuidD')}}
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#table").DataTable({
            ...
            ajax: "{{url_admin('master-data-owner/datatable')}}",
            columns: [
        ...
        {{Html::jsShowModal('update-data')}}
            ...
            $.ajax({
                url:"{{url_admin('master-data-owner/get-record')}}/"+$uuid,
