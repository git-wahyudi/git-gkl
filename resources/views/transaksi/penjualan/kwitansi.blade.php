				...
				<td colspan="3" style="border:1px solid;padding: 15px;line-height: 20px;">
					<table width="100%">
						<tr>
							...
							<td style="vertical-align: top;">{{strtoupper($pjl->nama)}}</td>
						</tr>
						<tr>
							<td style="vertical-align: top">Uang Sejumlah</td>
							<td style="vertical-align: top">:</td>
							<td style="vertical-align: top">{{ucwords(terbilang($pjl->uang_muka))}} Rupiah</td>
						</tr>
						<tr>
							<td style="vertical-align: top">Untuk Pembayaran</td>
							<td style="vertical-align: top">:</td>
							<td style="vertical-align: top">{{$ket}} Kav. {{$pjl->project}} No. {{$kavling}}</td>
						</tr>
					</table>
				</td>
			</tr>
				...
				<td style="border-top: 1px solid;border-bottom: 1px solid;padding-left: 0px;padding-right: 0px;">
					<table width="100%" style="border-collapse: collapse;font-size: 18px;margin-left: 0px;margin-right: 0px;margin-top: 1px;margin-bottom: 1px;">
						<tr>
							...
							<td style="padding-top: 8px;padding-bottom: 5px;border-top: 1px solid;border-bottom: 1px solid;background:  #f5f4f4;text-align: center;">{{toMoney($pjl->uang_muka)}}</td>
						</tr>
					</table>
				</td>
				<td></td>
				<td style="text-align: center;">Jambi, {{tgl_indo($pjl->tgl_penjualan)}}</td>
			</tr>
			<tr>
				<td colspan="3"></td>
			</tr>
